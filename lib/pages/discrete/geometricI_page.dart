...
import 'package:probistics/utils/disc_prob_dist_calc/geom_dist_kfailures.dart';
import 'package:charcode/html_entity.dart';

class GeometricIPage extends StatefulWidget {
  @override
  _GeometricIPageState createState() => _GeometricIPageState();
}

class _GeometricIPageState extends State<GeometricIPage> {
  ...
  void _calculateProbistics() {
    if (textEditingControllerOfP.text.isEmpty ||
      ...
      setState(() {
        probistics =
            GeometricDistributionKFailures.getAllCasesOfGeometricDistKFailures(
  ...
  Widget _buildInputField(
    ...
    return Padding(
      ...
      child: TextField(
        ...
        style: TextStyle(
            fontSize: 20.0, color: Colors.purpleAccent.shade100, height: 0.7),
